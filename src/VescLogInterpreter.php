    ...
    public function init()
    {
        ...
        Event::on(
            ...
            function (RegisterUrlRulesEvent $event) {
                $event->rules['siteActionTrigger1'] = 'vesc-log-interpreter/process';
            }
        );
        ...
        Event::on(
            ...
            function (RegisterUrlRulesEvent $event) {
                $event->rules['cpActionTrigger1'] = 'vesc-log-interpreter/process/do-something';
            }
        );
        ...
        Event::on(
            ...
            function (Event $event) {
                ...
                $variable->set('vescLogInterpreter', VescLogInterpreterVariable::class);
            }
        );
